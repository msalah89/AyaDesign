...
(function() {
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
	...
	switch (control)
		{
		case 'tl':			
			SelectedIconImage.src = 'img/icono_mover'+n+'.jpg';
			break;
		case 'tr':
			if (flipiX && !flipiY) { n='2'; }
			if (!flipiX && flipiY) { n='3'; }
			if (flipiX && flipiY) { n='4'; }
			SelectedIconImage.src = 'img/icono_rotar'+n+'.jpg';
			break;
		case 'mt':
			SelectedIconImage.src = 'img/icono_escala_vertical'+n+'.jpg';
			break;
		case 'bl':
			if (flipiY) { n='2'; }
			SelectedIconImage.src = 'img/icono_borrar'+n+'.jpg';
			break;
		case 'br':
			if (flipiX || flipiY) { n='2'; }
			if (flipiX && flipiY) { n=''; }
			SelectedIconImage.src = 'img/icono_escala_oblicua'+n+'.jpg';
			break;
		case 'mb':
			SelectedIconImage.src = 'img/icono_escala_vertical'+n+'.jpg';
			break;
		case 'ml':
			SelectedIconImage.src = 'img/icono_escala_horizontal'+n+'.jpg';
			break;
		case 'mr':
			SelectedIconImage.src = 'img/icono_escala_horizontal'+n+'.jpg';
			break;
