...
'http://do.convertapi.com/PowerPoint2Image',
'http://do.convertapi.com/Lotus2Image',
'http://do.convertapi.com/SnapShot2Image',

'http://do.convertapi.com/Pdf2Image',
'http://do.convertapi.com/Xps2Image',
'http://do.convertapi.com/Word2Image',
'http://do.convertapi.com/RichText2Image',
'http://do.convertapi.com/Publisher2Image',
'http://do.convertapi.com/Excel2Image',
'http://do.convertapi.com/Text2Image',
'http://do.convertapi.com/OpenOffice2Image',
'http://do.convertapi.com/Email2Image',
...
function getImages(urlfile) {
    $.ajax({
        ...
        async: false,
        cache: false,
        url: '/Home/UploadZipFile',
        context: document.body,
        data: { 'fileUrl': urlfile, 'room': room },
        success: function (result) {
            var options = [];
