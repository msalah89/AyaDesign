/// <reference path="Scripts\fabric.js" />
/// <reference path="Scripts/linq.js" />
/// <reference path="Scripts/json-patch-duplex.js" />
/// <reference path="Scripts/lz-string-1.0.2.js" />
/// <reference path="Scripts/BSON.min.js" />
/// <reference path="Scripts/base64-string.js" />
/// <reference path="Scripts/gzip.js" /> 
 
/// <reference path="Scripts/jsend-2.0.0.source.js" />
    ...
    boardhub.client.getSlides = function (roomSlides) {
        ...
        for (var i = 0; i < roomSlides.length; i++) {
            if (!loadingSlide) {
                ...
                var tempslide = { 'initCanvas': roomSlides[i].initCanvas, 'SlideId': roomSlides[i].SlideId, 'SlideHistory': roomSlides[i].SlideHistory };
...
var Board = (function () {
    ...
    var boardFunctions = {
        ...
        updateThumbinal: function (slideid) {
            ...
            //    this.getSlide(tempslide.initCanvas, tempslide.SlideId, tempslide.SlideHistory);
            //}
            //else {
    ...
    setTimeout(function() {
       ...
       // var lz = lzw_encode(jsonstring); // LZString.compressToUTF16(jsonstring);
        if (currentslide) {
            ...
            boardhub.server.sendCanvas(room, currentslide.SlideNo, slidehstories);
